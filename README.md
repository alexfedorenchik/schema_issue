...
You can then execute your native executable with: `./build/schema_issue-1.0-SNAPSHOT-runner`
...
- SmallRye GraphQL ([guide](https://quarkus.io/guides/smallrye-graphql)): Create GraphQL Endpoints using the code-first approach from MicroProfile
  GraphQL
